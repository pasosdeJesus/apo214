    ...
    module Models
      module Lugarpreliminar
        ...
        included do
          ...
          belongs_to :otrolubicacionpre, class_name: 'Msip::Ubicacionpre', 
          ...
          belongs_to :archivokml, class_name: 'Msip::Anexo', validate: true,
          ...
          accepts_nested_attributes_for :listainfofoto,
            allow_destroy: true, reject_if: :all_blank
          has_many :msip_anexo, :through => :listainfofoto, 
          ...
          accepts_nested_attributes_for :listaanexo,
            allow_destroy: true, reject_if: :all_blank
          has_many :msip_anexo, :through => :listaanexo, 
            class_name: 'Msip::Anexo'
          accepts_nested_attributes_for :msip_anexo,  reject_if: :all_blank
